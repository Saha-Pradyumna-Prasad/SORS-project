...
<head>
    ...
    <title>BBA Faculty | AM University</title>
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Playfair Display', serif, 'Segoe UI'; }
        ...
        .dept-hero { background: linear-gradient(rgba(28, 75, 84, 0.8), rgba(28, 75, 84, 0.8)), url('https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=1200'); background-size: cover; background-position: center; color: white; padding: 80px 5%; text-align: center; }
...
<body>
    ...
    <div class="dept-hero"><h1>Department of BBA</h1><p>Leadership, Strategy, and Global Commerce</p></div>
    <div class="faculty-container">
        <?php 
include('db.php'); 
// Set this to match the dept_code in the SQL table for each file
$dept_code = 'BBA'; // Use 'BBA', 'CE', 'EEE', 'ENG', 'IT', or 'PHA' for other files
?>
...
<div class="faculty-grid">
    ...
    ?>
        ...
        <!--<div class="faculty-grid">
            <div class="faculty-card"><div class="image-holder"><img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400"></div><div class="info"><h3>Prof. Peter Drucker</h3><span>Head of Dept</span><p>Strategic Management.</p></div></div>
            <div class="faculty-card"><div class="image-holder"><img src="https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=400"></div><div class="info"><h3>Dr. Philip Kotler</h3><span>Professor</span><p>Marketing Strategy Expert.</p></div></div>
            <div class="faculty-card"><div class="image-holder"><img src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400"></div><div class="info"><h3>Dr. Mary Parker</h3><span>Associate Professor</span><p>Organizational Behavior.</p></div></div>
            <div class="faculty-card"><div class="image-holder"><img src="https://images.unsplash.com/photo-1560250097-0b93528c311a?w=400"></div><div class="info"><h3>Dr. Adam Smith</h3><span>Assistant Professor</span><p>Micro & Macro Economics.</p></div></div>
            <div class="faculty-card"><div class="image-holder"><img src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400"></div><div class="info"><h3>Dr. Warren Buffett</h3><span>Senior Lecturer</span><p>Finance & Investments.</p></div></div>
        </div>-->
    </div>
 <footer>
