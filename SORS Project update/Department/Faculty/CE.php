...
<head>
    ...
    <title>Civil Faculty | AM University</title>
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Playfair Display', serif, 'Segoe UI'; }
        ...
        .dept-hero { background: linear-gradient(rgba(28, 75, 84, 0.8), rgba(28, 75, 84, 0.8)), url('https://images.unsplash.com/photo-1503387762-592dea58ef21?w=1200'); background-size: cover; background-position: center; color: white; padding: 80px 5%; text-align: center; }
...
<body>
    ...
    <div class="dept-hero"><h1>Department of Civil</h1><p>Design, Planning, and Urban Arts</p></div>
    <div class="faculty-container">

    <?php 
include('db.php'); 
// Set this to match the dept_code in the SQL table for each file
$dept_code = 'CE'; // Use 'BBA', 'CE', 'EEE', 'ENG', 'IT', or 'PHA' for other files
?>
