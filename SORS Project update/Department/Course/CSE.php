...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Playfair Display', serif, 'Segoe UI'; }
        ...
        .hero { background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=1200'); height: 40vh; display: flex; align-items: center; justify-content: center; color: white; text-align: center; background-size: cover; background-position: center; }
...
<body>
    ...
    <div class="hero"><div><h1>CSE Department</h1><p>Empowering Innovation through Computational Excellence</p></div></div>
    <div class="container">

    <?php 
include('db.php'); 
$dept = 'CSE'; // Change this per file (e.g., 'BBA', 'IT', etc.)
?>
    ...
    ?>
       ...
       <!-- <div class="course-grid">
            <div class="course-card">
                ...
                <p><strong>Focus:</strong> Data organization.</p>
                <p><strong>Needed For:</strong> System efficiency.</p><p><strong>Builds:</strong> Logical architecture skills.</p></div>
            <div class="course-card"><h3>Algorithms</h3><p><strong>Focus:</strong> Problem solving.</p><p><strong>Needed For:</strong> High-end coding.</p><p><strong>Builds:</strong> Analytical optimization.</p></div>
            <div class="course-card"><h3>Artificial Intelligence</h3><p><strong>Focus:</strong> Neural networks.</p><p><strong>Needed For:</strong> Future automation.</p><p><strong>Builds:</strong> Predictive modeling.</p></div>
            <div class="course-card"><h3>Database Systems</h3><p><strong>Focus:</strong> Data storage.</p><p><strong>Needed For:</strong> Enterprise backend.</p><p><strong>Builds:</strong> Query and management rigor.</p></div>
            <div class="course-card"><h3>Cyber Security</h3><p><strong>Focus:</strong> Network defense.</p><p><strong>Needed For:</strong> Digital safety.</p><p><strong>Builds:</strong> Ethical hacking expertise.</p></div>
            <div class="course-card"><h3>Software Engineering</h3><p><strong>Focus:</strong> Project lifecycle.</p><p><strong>Needed For:</strong> Industry teamwork.</p><p><strong>Builds:</strong> Collaborative discipline.</p></div>
            <div class="course-card"><h3>Machine Learning</h3><p><strong>Focus:</strong> Pattern recognition.</p><p><strong>Needed For:</strong> Big data analytics.</p><p><strong>Builds:</strong> Statistical intelligence.</p></div>
        </div> -->
    </div>
