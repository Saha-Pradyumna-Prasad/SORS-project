...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Playfair Display', serif, 'Segoe UI'; }
        ...
        .hero { background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?w=1200'); height: 40vh; display: flex; align-items: center; justify-content: center; color: white; text-align: center; background-size: cover; background-position: center; }
...
<body>
    ...
    <div class="hero"><div><h1>ENG Department</h1><p>Exploring the Power of Language and Literature</p></div></div>
    <div class="container">

    <?php 
include('db.php'); 
$dept = 'ENG'; // Change this per file (e.g., 'BBA', 'IT', etc.)
?>
...
<div class="course-grid">
    ...
    ?>
      ...
      <!--  <div class="course-grid">
    <div class="course-card"><h3>Creative Writing</h3><p><strong>Focus:</strong> Fiction & Poetry.</p><p><strong>Needed For:</strong> Publishing.</p><p><strong>Builds:</strong> Narrative imagination.</p></div>
    <div class="course-card"><h3>Modern Linguistics</h3><p><strong>Focus:</strong> Language structure.</p><p><strong>Needed For:</strong> Communications.</p><p><strong>Builds:</strong> Analytical speech skills.</p></div>
    <div class="course-card"><h3>Victorian Prose</h3><p><strong>Focus:</strong> 19th-century literature.</p><p><strong>Needed For:</strong> Cultural research.</p><p><strong>Builds:</strong> Critical historical context.</p></div>
    <div class="course-card"><h3>Shakespearean Drama</h3><p><strong>Focus:</strong> Classical plays.</p><p><strong>Needed For:</strong> Performing arts.</p><p><strong>Builds:</strong> Deep textual interpretation.</p></div>
    <div class="course-card"><h3>Rhetoric & Debate</h3><p><strong>Focus:</strong> Persuasion.</p><p><strong>Needed For:</strong> Law and Politics.</p><p><strong>Builds:</strong> Oratory confidence.</p></div>
    <div class="course-card"><h3>Academic Research</h3><p><strong>Focus:</strong> Methodology.</p><p><strong>Needed For:</strong> Thesis writing.</p><p><strong>Builds:</strong> Investigative rigor.</p></div>
    <div class="course-card"><h3>Post-Colonial Lit</h3><p><strong>Focus:</strong> Global narratives.</p><p><strong>Needed For:</strong> Social advocacy.</p><p><strong>Builds:</strong> Global empathy.</p></div>
</div> -->
    </div>
