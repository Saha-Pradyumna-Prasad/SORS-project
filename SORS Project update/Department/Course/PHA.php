...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Playfair Display', serif, 'Segoe UI'; }
        ...
        .hero { background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('https://images.unsplash.com/photo-1587854680352-936b22b91030?w=1200'); height: 40vh; display: flex; align-items: center; justify-content: center; color: white; text-align: center; background-size: cover; background-position: center; }
...
<body>
    ...
    <div class="hero"><div><h1>PHA Department</h1><p>Advancing Healthcare through Pharmaceutical Science</p></div></div>
    <div class="container">

    <?php 
include('db.php'); 
$dept = 'PHA'; // Change this per file (e.g., 'BBA', 'IT', etc.)
?>
...
<div class="course-grid">
    ...
    ?>
       ...
       <!--
        <div class="course-grid">
    <div class="course-card"><h3>Pharmacology</h3><p><strong>Focus:</strong> Drug action.</p><p><strong>Needed For:</strong> Clinical practice.</p><p><strong>Builds:</strong> Biological reasoning.</p></div>
    <div class="course-card"><h3>Medicinal Chemistry</h3><p><strong>Focus:</strong> Drug design.</p><p><strong>Needed For:</strong> Lab research.</p><p><strong>Builds:</strong> Synthetic chemistry skills.</p></div>
    <div class="course-card"><h3>Biopharmaceutics</h3><p><strong>Focus:</strong> Absorption.</p><p><strong>Needed For:</strong> Dosage optimization.</p><p><strong>Builds:</strong> Pharmacokinetic expertise.</p></div>
    <div class="course-card"><h3>Clinical Pharmacy</h3><p><strong>Focus:</strong> Patient care.</p><p><strong>Needed For:</strong> Hospital practice.</p><p><strong>Builds:</strong> Diagnostic support.</p></div>
    <div class="course-card"><h3>Forensic Pharmacy</h3><p><strong>Focus:</strong> Drug laws.</p><p><strong>Needed For:</strong> Legal compliance.</p><p><strong>Builds:</strong> Ethical judgment.</p></div>
    <div class="course-card"><h3>Microbiology</h3><p><strong>Focus:</strong> Pathogens.</p><p><strong>Needed For:</strong> Infection control.</p><p><strong>Builds:</strong> Lab safety discipline.</p></div>
    <div class="course-card"><h3>Cosmetic Science</h3><p><strong>Focus:</strong> Topical agents.</p><p><strong>Needed For:</strong> Derma-industry.</p><p><strong>Builds:</strong> Formulation precision.</p></div>
</div> -->
    </div>
